...
export class sdwTool extends HTMLElement {
    ...
    constructor () {
        ...
        this.settingsList = ['description', 'site-name', 'site-title', 'site-stylesheets', 'site-scripts', 'site-fonts', 'text-content', 'custom-element' , 'attributes', 'css-title', 'position', 'display', 'flex-child', 'float', 'margin', 'border', 'border-radius', 'padding', 'size', 'overflow', 'shadows', 'background', 'backdrop-filters', 'opacity', 'transform', 'transition', 'filter', 'cursor', 'text-shadows', 'typography', 'paragraph', 'paragraph-columns']
        ...
        this.tagsList = {
            ...
            img:        { childs: [],           description: 'Image',                   defaultText: '',                    settings: ['description', 'attributes', 'css-title', 'position', 'display', 'flex-child', 'float', 'margin', 'border', 'border-radius', 'padding', 'size', 'overflow', 'shadows', 'background', 'backdrop-filters', 'opacity', 'transform', 'transition', 'filter', 'cursor', 'text-shadows', 'typography', 'paragraph', 'paragraph-columns']},
