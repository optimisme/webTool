...
export class sdwInputFloat extends HTMLElement {
    ...
    async load () {
        ...
        refInput.setAttribute("type", "number")
        if (this.hasAttribute("data-step")) { refInput.setAttribute("step", this.getAttribute("data-step")) }
        if (this.hasAttribute("data-min"))  { refInput.setAttribute("min", this.getAttribute("data-min")) }
        if (this.hasAttribute("data-max"))  { refInput.setAttribute("max", this.getAttribute("data-max")) }
        if (this.hasAttribute("placeholder")) {
            refInput.setAttribute("placeholder", this.getAttribute("placeholder"))
        }
        refInput.value = ""
